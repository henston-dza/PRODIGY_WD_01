	...
	<body>
		...
		<section id="login" class="showcase">
			<div class="showcase-text" data-aos="slide-up">
				...
				<h1> STEERCLEAR</h1>
				<p>Driven By Trust, Fueled By Quality.</p>
			</div>
    ...
    <video autoplay muted loop>
                    ...
                    foreach($thoughts as $row){
                        ...
                        echo '<div class="post" data-aos="slide-up">
                					...
                					<div class="post-mini2">
                						...
                						<i class="far fa-user"> <p style="display: inline;">TEAM STEERCLEAR</p></i>
		...
		<footer>
			<div class="social">
			  ...
			  <a href="#"> <i class="fab fa-youtube"> <span></span> </i> </a><br>
			  <a href="contactus.html"><b>Terms&Conditions</b></a>
		  </div>
		  <div class="credit">
		  	<h1>STEERCLEAR | Developed by team SteerClear</h1>
		  </div>
		</footer>
