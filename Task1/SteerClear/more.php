...
<html lang="en" dir="ltr">
	<head>
		...
		<title>STEERCLEAR| more</title>
	</head>
	<body>
		<div class="nav">
			<a href="javascript:history.back();"><i class="fas fa-angle-double-left"></i></a><h1>STEERCLEAR</h1>
		</div>
        ...
        <footer>
		  ...
		  <div class="credit">
		  	<h1>STEERCLEAR| Developed by STEERCLEAR Team</h1>
		  </div>
      </footer>
	</body>
</html>
